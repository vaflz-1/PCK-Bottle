...
private let localizedStrings: [AppLocale: [String: String]] = [
    .ru: [
        ...
        "noPckHint": "Откройте игру или .pck слева, чтобы увидеть пакеты здесь.",
        ...
        "fromSource": "из %@",
        "aboutApp": "О программе PCK Bottle",
        "aboutCredits": "Нативный редактор пакетов Godot .pck для macOS.",
    ...
    .en: [
        ...
        "noPckHint": "Open a game or .pck on the left to list its packages here.",
        ...
        "fromSource": "from %@",
        "aboutApp": "About PCK Bottle",
        "aboutCredits": "A native macOS editor for Godot .pck packages.",
    ...
    .zh: [
        ...
        "noPckHint": "在左侧打开游戏或 .pck，包将显示在这里。",
        ...
        "supportShort": "支持",
        "fromSource": "来自 %@",
        "aboutApp": "关于 PCK Bottle",
        "aboutCredits": "用于 Godot .pck 包的原生 macOS 编辑器。",
